  ...
  return (
    <main className="min-h-screen bg-blue-50 p-10 ">
      <div className="flex justify-between items-center ">
        <h1 className="font-bold text-2xl text-blue-800">Welcome {loginUser?.user?.name}</h1>
        <button onClick={()=>signOut({callbackUrl:'/'})} className="p-3 bg-red-800 text-white rounded">Logout</button>
      </div>
